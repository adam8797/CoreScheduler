...
IF EXISTS(SELECT * FROM sys.databases where name='Quartz')
	BEGIN
		ALTER DATABASE [Quartz] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
...
CREATE TABLE [dbo].[Scripts](
	...
	[TreeDirectory] [nvarchar](250) NULL,
...
CREATE TABLE [dbo].[JobEvents](
 ...
 CONSTRAINT [PK_JobEvents] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
ALTER TABLE [dbo].[JobEvents] ADD  CONSTRAINT [DF_JobEvents_RunOrder]  DEFAULT ((0)) FOR [RunOrder]
GO
...
CREATE TABLE [dbo].[AssemblyData](
	[Id] [uniqueidentifier] NOT NULL,
	[FileName] [nvarchar](150) NOT NULL,
	[Data] [varbinary](max) NOT NULL,
 CONSTRAINT [PK_AssemblyData] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
CREATE TABLE [dbo].[AssemblyInfo](
	[Id] [uniqueidentifier] NOT NULL,
	[Name] [nvarchar](150) NOT NULL,
	[FullName] [nvarchar](150) NOT NULL,
	[Version] [nvarchar](50) NOT NULL,
	[TreeDirectory] [nvarchar](250) NULL,
 CONSTRAINT [PK_ReferenceAssemblies] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
